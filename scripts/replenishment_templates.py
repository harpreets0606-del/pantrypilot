...
SLOTS = [
    # Slot 2: Skincare daily — LRP + CeraVe + Wild Ferns + Sukin + Weleda
    {
        ...
        "products": [
            {"name": "La Roche-Posay Effaclar Duo+M 40ml", "price": "32.81", "url": _coll("all")},
            {"name": "CeraVe Face Moisturising Lotion PM 52ml", "price": "26.99", "url": _coll("all")},
            {"name": "Wild Ferns Bee Venom Moisturiser 100g", "price": "45.99", "url": _coll("all")},
            {"name": "Weleda Skin Food 75ml", "price": "30.99", "url": _coll("all")},
        ],
    ...
    # Slot 3: Sun protection — LRP Anthelios + CeraVe SPF50 + Cetaphil Kids + Skinnies Kids + Natio
    {
        ...
        "products": [
            {"name": "La Roche-Posay Anthelios UVm400 SPF 50+ 50ml", "price": "35.34", "url": _coll("all")},
            {"name": "CeraVe Facial Lotion SPF50 52ml", "price": "26.64", "url": _coll("all")},
            {"name": "Cetaphil Sun Kids SPF50 150ml", "price": "32.72", "url": _coll("all")},
            {"name": "Skinnies Kids Sun Buster SPF50 100ml", "price": "36.49", "url": _coll("all")},
        ],
    ...
    # Slot 4: Body care — Palmer's + Vaseline
    {
        ...
        "products": [
            {"name": "Palmer's Tahitian Vanilla Body Oil 192ml", "price": "20.29", "url": _coll("all")},
            {"name": "Palmer's Tahitian Vanilla Body Lotion 400ml", "price": "12.27", "url": _coll("all")},
            {"name": "Palmer's Foot Magic 60g", "price": "12.37", "url": _coll("all")},
            {"name": "Vaseline Petroleum Jelly 100g", "price": "7.55", "url": _coll("all")},
        ],
    ...
    # Slot 5: Hair care — BEING + Sukin + Hask + Shea Moisture + Neutrogena T/Gel
    {
        ...
        "products": [
            {"name": "BEING Shampoo Curl Power 354ml", "price": "8.18", "url": _coll("all")},
            {"name": "Sukin Natural Balance Shampoo 1L", "price": "27.87", "url": _coll("all")},
            {"name": "Hask Curl Care Curl Defining Cream 198ml", "price": "14.60", "url": _coll("all")},
            {"name": "Neutrogena T/Gel Salicylic Acid Shampoo 200ml", "price": "17.62", "url": _coll("all")},
        ],
    ...
    # Slot 6: Daily multi & immune — Elevit, GO Healthy D+C+Zinc, Clinicians D3 (replaces paused Hayfexo)
    {
        ...
        "products": [
            {"name": "Elevit Preconception & Pregnancy Multi 100 Tablets", "price": "79.62", "url": _coll("all")},
            {"name": "GO Healthy Vitamin D + Vitamin C + Zinc Multi 60s", "price": "17.67", "url": _coll("all")},
            {"name": "Clinicians Sunshine Vitamin D3 60 Tablets", "price": "17.04", "url": _coll("all")},
            {"name": "Sanderson Co-Enzyme Q10 400mg 30s", "price": "34.87", "url": _coll("all")},
        ],
    ...
    # Slot 7: Magnesium — GO Healthy + Nutra-life + Sanderson + Clinicians
    {
        ...
        "products": [
            {"name": "GO Healthy Magnesium Sleep 120 VCaps", "price": "31.67", "url": _coll("all")},
            {"name": "GO Healthy Magnesium Sleep 1-A-Day 200 Caps", "price": "58.09", "url": _coll("all")},
            {"name": "Nutra-Life Magnesium Glycinate 60s", "price": "23.03", "url": _coll("all")},
            {"name": "Sanderson High Absorption Magnesium FX 120 Tablets", "price": "26.31", "url": _coll("all")},
        ],
    ...
    # Slot 8: Probiotic / gut — Clinicians Flora Restore + GO Healthy Probiotic
    {
        ...
        "products": [
            {"name": "Clinicians Flora Restore 30 Capsules", "price": "27.25", "url": _coll("all")},
            {"name": "GO Healthy GO Probiotic 75 Billion 1-A-Day 60 Capsules", "price": "61.56", "url": _coll("all")},
            {"name": "GO Healthy GO Probiotic 40 Billion 60 VCaps", "price": "49.99", "url": _coll("all")},
        ],
    ...
    # Slot 9: Omega 3 — Sanderson + GO Healthy + Clinicians Vegan
    {
        ...
        "products": [
            {"name": "Sanderson Omega 3 Fish Oil 3000 150 Capsules", "price": "39.45", "url": _coll("all")},
            {"name": "Sanderson Odourless Fish Oil 2000 220 Caps", "price": "28.26", "url": _coll("all")},
            {"name": "GO Healthy Fish Oil 2000mg Odourless 230 Caps", "price": "31.55", "url": _coll("all")},
            {"name": "Clinicians Vegan Omega-3 Algae Oil 50 Capsules", "price": "45.71", "url": _coll("all")},
        ],
    ...
    # Slot 10: Hydration / electrolytes — Nothing Naughty
    {
        ...
        "products": [
            {"name": "Nothing Naughty Electrolyte Watermelon 515g", "price": "18.76", "url": _coll("all")},
            {"name": "Nothing Naughty Electrolyte Valencia Orange 515g", "price": "21.39", "url": _coll("all")},
            {"name": "Nothing Naughty Electrolyte Lemon & Lime 515g", "price": "21.53", "url": _coll("all")},
        ],
    ...
    # Slot 11: Sports / protein — Musashi + Nothing Naughty
    {
        ...
        "products": [
            {"name": "Musashi Creatine Unflavoured 350g", "price": "32.48", "url": _coll("all")},
            {"name": "Nothing Naughty Pure Collagen Peptide Powder 500g", "price": "49.65", "url": _coll("all")},
            {"name": "Nothing Naughty Protein Bar 40g (Raspberry)", "price": "8.64", "url": _coll("all")},
        ],
    ...
    # Slot 12: Cosmetics daily — FLASH + Maybelline + Natio
    {
        ...
        "products": [
            {"name": "FLASH Amplifying Eyelash Serum 2ml", "price": "56.10", "url": _coll("all")},
            {"name": "Maybelline Falsies Lash Lift Volumising Mascara", "price": "22.81", "url": _coll("all")},
            {"name": "Maybelline Great Lash Volumizing Mascara", "price": "12.54", "url": _coll("all")},
            {"name": "1000HOUR Lash & Brow Tint Kit Light Brown", "price": "21.28", "url": _coll("all")},
        ],
    ...
    # Slot 13: Baby & postpartum — Sudocrem + Bepanthen + Viva la Vulva + Lansinoh
    {
        ...
        "products": [
            {"name": "Sudocrem Antiseptic Healing Cream 125g", "price": "14.16", "url": _coll("all")},
            {"name": "Bepanthen Nappy Rash Ointment 30g", "price": "9.54", "url": _coll("all")},
            {"name": "Viva la Vulva Healing Perineal Spray 100ml", "price": "35.49", "url": _coll("all")},
            {"name": "Lansinoh HPA Lanolin Nipple Cream 15g", "price": "14.19", "url": _coll("all")},
        ],
    ...
    # Slot 14: Oral care daily (broadened from Oracoat-only) — Oracoat + Biotene + Miradent + Oral-B
    {
        ...
        "body_continuation": "Reorder your favourites at NZ's best prices, with free delivery over $79.",
        "products": [
            {"name": "Oracoat Xylimelts Mild Mint 40 Pack", "price": "41.92", "url": _coll("all")},
            {"name": "Oracoat Xylimelts Mint Free 40 Pack", "price": "44.21", "url": _coll("all")},
            {"name": "Biotene Mouthwash 470ml", "price": "34.11", "url": _coll("all")},
            {"name": "Miradent Xylitol Spearmint Chewing Gum 30s", "price": "12.86", "url": _coll("all")},
        ],
    ...
    # Slot 15: Meal replacement (Optifast — keep, broadened from one flavour to full range)
    {
        ...
        "products": [
            {"name": "OPTIFAST VLCD Shake Vanilla 18×53g", "price": "83.02", "url": _coll("all")},
            {"name": "OPTIFAST VLCD Shake Chocolate 12×53g", "price": "58.11", "url": _coll("all")},
            {"name": "OPTIFAST VLCD Shake Banana 12×53g", "price": "50.75", "url": _coll("all")},
            {"name": "OPTIFAST VLCD Shake Strawberry 12×53g", "price": "46.08", "url": _coll("all")},
        ],
    ...
    # Slot 16: First aid & wound care (replaces Optifast clone) — Band-Aid + Savlon + USL Swabs + Multisorb
    {
        ...
        "products": [
            {"name": "Band-Aid Tough Strips Regular Plasters 40", "price": "7.97", "url": _coll("all")},
            {"name": "Savlon Antiseptic Cream 30g", "price": "12.87", "url": _coll("all")},
            {"name": "USL Medical Alcohol Swabs 70% 200 Pack", "price": "14.60", "url": _coll("all")},
            {"name": "Multisorb Non Woven Swabs 7.5×7.5cm 100 Swabs", "price": "13.58", "url": _coll("all")},
        ],
